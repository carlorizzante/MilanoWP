 ...
 * @since 0.9.0
 */
function milano_page_navi( $before = '', $after = '' ) {
	...
	echo '<li>';
	next_posts_link( 'Next', 'milano' );
	echo '</li>';

	if ( $end_page < $max_page ) {
		$last_page_text = __( 'Last', 'milano' );
